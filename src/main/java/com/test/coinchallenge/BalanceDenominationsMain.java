...
public class BalanceDenominationsMain {
    public static void main(String[] args) {
        BalanceDenominations balanceChange = BalanceDenominationsFactory.createBalanceDenomination(Country.INDIA);
        //printUsCurrency(balanceChange.findBalanceDenominations(287));
        printIndiaCurrency(balanceChange.findBalanceDenominations(10824));
    }

    private static void printUsCurrency(Map<CurrencyMarker, Integer> bdMap) {
    ...
    private static void printIndiaCurrency(Map<CurrencyMarker, Integer> dMap) {
        StringBuilder resultStr = new StringBuilder();
